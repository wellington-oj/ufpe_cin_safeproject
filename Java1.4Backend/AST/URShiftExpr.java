...
public class URShiftExpr extends ShiftExpr implements Cloneable {
   ...
   * @declaredat /home/uoji/JastAddJ/Java1.4Backend/CodeGeneration.jrag:1032
   */
  void emitOperation(CodeGeneration gen)    { type().ushr(gen); }
  /**
   * @ast method 
   * @aspect CreateBCode
   * @declaredat /home/uoji/JastAddJ/Java1.4Backend/CreateBCode.jrag:896
   */
   ...
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/ConstantExpression.jrag:126
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect PrettyPrint
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:408
   */
  @SuppressWarnings({"unchecked", "cast"})
