...
public class RShiftExpr extends ShiftExpr implements Cloneable {
   ...
   * @declaredat /home/uoji/JastAddJ/Java1.4Backend/CodeGeneration.jrag:1031
   */
  void emitOperation(CodeGeneration gen)     { type().shr(gen); }
  /**
   * @ast method 
   * @aspect CreateBCode
   * @declaredat /home/uoji/JastAddJ/Java1.4Backend/CreateBCode.jrag:895
   */
   ...
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/ConstantExpression.jrag:125
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect PrettyPrint
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:407
   */
  @SuppressWarnings({"unchecked", "cast"})
