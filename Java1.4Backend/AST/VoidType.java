...
public class VoidType extends TypeDecl implements Cloneable {
   ...
   * @ast method 
   * @aspect PrettyPrint
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:858
   */
   ...
   * @declaredat /home/uoji/JastAddJ/Java1.4Backend/CodeGeneration.jrag:613
   */
  public void emitReturn(CodeGeneration gen)      { gen.emit(Bytecode.RETURN);}
  /**
   * @ast method 
   * @aspect CodeGeneration
   * @declaredat /home/uoji/JastAddJ/Java1.4Backend/CodeGeneration.jrag:845
   */
  public void emitDup(CodeGeneration gen)      { }
  /**
   * @ast method 
   * @aspect CodeGeneration
   * @declaredat /home/uoji/JastAddJ/Java1.4Backend/CodeGeneration.jrag:850
   */
  public void emitDup_x1(CodeGeneration gen)   { }
  /**
   * @ast method 
   * @aspect CodeGeneration
   * @declaredat /home/uoji/JastAddJ/Java1.4Backend/CodeGeneration.jrag:855
   */
  public void emitDup_x2(CodeGeneration gen)   { }
  /**
   * @ast method 
   * @aspect CodeGeneration
   * @declaredat /home/uoji/JastAddJ/Java1.4Backend/CodeGeneration.jrag:860
   */
   ...
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:56
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:203
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:414
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(isFinal && num == state().boundariesCrossed) instanceOf_TypeDecl_values.put(_parameters, Boolean.valueOf(instanceOf_TypeDecl_value));
   ...
   * @attribute syn
   * @aspect TypeWideningAndIdentity
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:487
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat /home/uoji/JastAddJ/Java1.4Backend/ConstantPoolNames.jrag:25
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(isFinal && num == state().boundariesCrossed) typeDescriptor_computed = true;
   ...
   * @declaredat /home/uoji/JastAddJ/Java1.4Backend/Java2Rewrites.jrag:55
   */
  @SuppressWarnings({"unchecked", "cast"})
