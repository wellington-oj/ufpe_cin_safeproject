...
public class CharacterLiteral extends Literal implements Cloneable {
   ...
   * @ast method 
   * @aspect PrettyPrint
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:271
   */
   ...
   * @declaredat /home/uoji/JastAddJ/Java1.4Backend/CodeGeneration.jrag:558
   */
   ...
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/ConstantExpression.jrag:303
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(isFinal && num == state().boundariesCrossed) constant_computed = true;
   ...
   * @attribute syn
   * @aspect TypeAnalysis
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:305
   */
  @SuppressWarnings({"unchecked", "cast"})
