...
public class PrimitiveTypeAccess extends TypeAccess implements Cloneable {
   ...
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/LookupType.jrag:146
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(isFinal && num == state().boundariesCrossed) decls_computed = true;
   ...
   * @attribute syn nta
   * @aspect TypeScopePropagation
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/LookupType.jrag:147
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(isFinal && num == state().boundariesCrossed) getPackage_computed = true;
   ...
   * @attribute syn nta
   * @aspect TypeScopePropagation
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/LookupType.jrag:148
   */
  @SuppressWarnings({"unchecked", "cast"})
  public String getID() {
    if(getID_computed) {
