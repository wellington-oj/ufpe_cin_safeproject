...
public class AnonymousDecl extends ClassDecl implements Cloneable {
   ...
   * @declaredat /home/uoji/JastAddJ/Java1.4Backend/GenerateClassfile.jrag:355
   */
   ...
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/AnonymousClasses.jrag:30
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn nta
   * @aspect AnonymousClasses
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/AnonymousClasses.jrag:32
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(isFinal && num == state().boundariesCrossed) getSuperClassAccessOpt_computed = true;
   ...
   * @attribute syn nta
   * @aspect AnonymousClasses
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/AnonymousClasses.jrag:38
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(isFinal && num == state().boundariesCrossed) getImplementsList_computed = true;
   ...
   * @attribute syn
   * @aspect GenerateClassfile
   * @declaredat /home/uoji/JastAddJ/Java1.4Backend/GenerateClassfile.jrag:329
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute inh
   * @aspect AnonymousClasses
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/AnonymousClasses.jrag:14
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute inh
   * @aspect AnonymousClasses
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/AnonymousClasses.jrag:18
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute inh
   * @aspect AnonymousClasses
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/AnonymousClasses.jrag:165
   */
  @SuppressWarnings({"unchecked", "cast"})
  ...
  public ASTNode rewriteTo() {
    // Declared in /home/uoji/JastAddJ/Java1.4Frontend/AnonymousClasses.jrag at line 52
    if(noConstructor()) {
  ...
  /**
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/AnonymousClasses.jrag:52
   * @apilevel internal
