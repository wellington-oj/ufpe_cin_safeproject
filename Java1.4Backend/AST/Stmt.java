...
public abstract class Stmt extends ASTNode<ASTNode> implements Cloneable {
   ...
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/UnreachableStatements.jrag:14
   */
   ...
   * @ast method 
   * @aspect CreateBCode
   * @declaredat /home/uoji/JastAddJ/Java1.4Backend/CreateBCode.jrag:1172
   */
   ...
   * @attribute syn
   * @aspect DA
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:325
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(isFinal && num == state().boundariesCrossed) isDAafter_Variable_values.put(_parameters, Boolean.valueOf(isDAafter_Variable_value));
   ...
   * @attribute syn
   * @aspect DU
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:776
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(isFinal && num == state().boundariesCrossed) isDUafter_Variable_values.put(_parameters, Boolean.valueOf(isDUafter_Variable_value));
   ...
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/LookupVariable.jrag:129
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect NameCheck
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/NameCheck.jrag:396
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect PrettyPrint
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:762
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect UnreachableStatements
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/UnreachableStatements.jrag:29
   */
  @SuppressWarnings({"unchecked", "cast"})
...
if(isFinal && num == state().boundariesCrossed) canCompleteNormally_computed = true;
   ...
   * @attribute syn
   * @aspect CreateBCode
   * @declaredat /home/uoji/JastAddJ/Java1.4Backend/CreateBCode.jrag:1396
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute syn
   * @aspect CreateBCode
   * @declaredat /home/uoji/JastAddJ/Java1.4Backend/CreateBCode.jrag:1415
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute inh
   * @aspect DA
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:232
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute inh
   * @aspect DU
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/DefiniteAssignment.jrag:690
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute inh
   * @aspect LookupMethod
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/LookupMethod.jrag:24
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/LookupType.jrag:96
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/LookupType.jrag:174
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute inh
   * @aspect VariableScope
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/LookupVariable.jrag:16
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute inh
   * @aspect NestedTypes
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:512
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute inh
   * @aspect NestedTypes
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/TypeAnalysis.jrag:584
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute inh
   * @aspect UnreachableStatements
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/UnreachableStatements.jrag:27
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute inh
   * @aspect UnreachableStatements
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/UnreachableStatements.jrag:147
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @attribute inh
   * @aspect LocalNum
   * @declaredat /home/uoji/JastAddJ/Java1.4Backend/LocalNum.jrag:12
   */
  @SuppressWarnings({"unchecked", "cast"})
  public int localNum() {
...
if(isFinal && num == state().boundariesCrossed) localNum_computed = true;
  ...
  /**
   * @declaredat /home/uoji/JastAddJ/Java1.4Frontend/PrettyPrint.jadd:352
   * @apilevel internal
   */
